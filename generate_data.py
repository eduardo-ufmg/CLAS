...
def generate_to_classify_data(num_classes: int, num_dimensions: int, centers: List[np.ndarray], total_num_vertices: int, spread_factor: float, output_file: str, random_seed: int = None) -> np.ndarray:
    """
